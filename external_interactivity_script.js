/* ==========================================================================
   JS FOLDER - Core Data Assets, Canvas Rendering, & Pop-up Handling
   ========================================================================== */

/* 1. DATA ASSETS (E-Commerce & Blog Models) */
...
function populateMarquee(containerId, data, type) {
    ...
    // Duplicate entries to sustain flawless left-to-right loops
    container.innerHTML = itemsHTML + itemsHTML;
}

/* 3. MODAL POP-UP ARCHITECTURE (Allows background scroll) */
...
/* 4. PSEUDO-ROUTING (Trigger 404 views) */
...
/* 5. CANVAS ANIMATION MODULE (Neon Gold Heart Rate Pulse) */
